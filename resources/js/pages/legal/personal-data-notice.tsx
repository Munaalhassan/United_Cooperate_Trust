...
const sections = [
    {
        title: 'The personal data Fulton Bank Bank collects and processes',
...
Although concerted efforts are made to safeguard personal data, The Bank cannot guarantee the security of data transmitted to its Website simply because sending information via the internet is not completely safe.`,
    },
    {
        ...
        body: `Fulton Bank Bank / Globafin Group
...
Objections must be sent in writing to: Fulton Bank Bank, Corporate Governance, USA.`,
    },
    {
...
export default function PersonalDataNotice() {
    return (
        <PublicLayout>
            <Head title="Personal Data Notice | Fulton Bank Bank" />
