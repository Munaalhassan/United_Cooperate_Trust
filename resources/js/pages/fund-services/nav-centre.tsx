                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 flex flex-col lg:flex-row gap-20">
                    ...
                    >
                        ...
                        <div className="max-w-3xl">
                            <h2 className="text-3xl font-bold text-brand-navy mb-8">Net Asset Value Operations</h2>
                            
                            <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-light mb-16">
                                <p>
                                    Our NAV Centre provides accurate and timely Net Asset Value calculations, leveraging state-of-the-art technology and dedicated teams to ensure compliance and transparency for your fund operations.
                                </p>
                            </div>
