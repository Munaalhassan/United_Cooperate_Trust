                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 flex flex-col lg:flex-row gap-20">
                    ...
                    >
                        ...
                        <div className="max-w-3xl">
                            <h2 className="text-3xl font-bold text-brand-navy mb-8">Exclusive Tools for Business Efficiency</h2>
                            
                            <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-light mb-16">
                                <p>
                                    United Cooperate Trust Bank offers a range of business credit cards designed to streamline expense management and provide your team with global purchasing power. Our cards combine security with exclusive rewards tailored for corporate needs.
                                </p>
                            </div>
