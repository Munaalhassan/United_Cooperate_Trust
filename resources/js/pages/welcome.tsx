...
const services = [
    ...
    {
        title: "Official Fulton Bank Membership Enrollment",
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
                            <span className="sr-only">Fulton Bank Bank: </span>
                ...
                <div className="flex flex-col lg:flex-row min-h-[600px]">
                    ...
                    <div className="w-full lg:w-1/2 relative h-[400px] lg:h-auto">
                        <OptimizedImage 
                            ...
                            alt="Fulton Bank Headquarters in the USA Financial Hub"
                            width={1200}
                            height={800}
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="relative h-full p-8 md:p-12 lg:p-16 flex flex-col justify-end">
                                ...
                                <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">FB Online Platform</h3>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-white/80 text-sm mb-4">Request your bespoke FB card with global limits.</p>
                    ...
                    <div className="mt-32 p-12 bg-slate-50 border border-slate-100 rounded-2xl grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-slate-500 leading-relaxed">
                                Fulton Bank Bank operates under a full banking license, regulated by the CSSF and international financial authorities, ensuring the highest standards of compliance and security.
                            </p>
                        </div>
                        <div className="space-y-4">
                        ...
                        <div className="space-y-8 md:space-y-10">
                            <div className="flex flex-col sm:flex-row items-center sm:items-start lg:items-center gap-4 sm:gap-6 group">
                                ...
                                <div className="text-center sm:text-left">
                                    ...
                                    <p className="text-sm md:text-base font-medium break-all">info@fultonbank.com</p>
                                </div>
                            </div>
                            <div className="flex flex-col sm:flex-row items-center sm:items-start lg:items-center gap-4 sm:gap-6 group">
                                <div className="w-12 h-12 bg-white/5 flex items-center justify-center rounded-full group-hover:bg-brand-blue transition-all shrink-0">
                                ...
                                <div className="text-center sm:text-left">
                                    ...
                                    <p className="text-sm md:text-base font-medium break-all">customerservice@fultonbank.com</p>
                                </div>
                            </div>
                            <div className="flex flex-col sm:flex-row items-center sm:items-start lg:items-center gap-4 sm:gap-6 group">
                                ...
                                <div className="text-center sm:text-left">
                                    ...
                                    <p className="text-sm md:text-base font-medium break-all">loan@fultonbank.com</p>
                                </div>
                            </div>
