...
export default function ViewId({ member }: Props) {
    ...
    return (
        <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4 md:p-10">
            <Head>
                <title>{`ID Document - ${member.first_name} ${member.last_name} | Fulton Bank Admin`}</title>
            ...
            <div className="w-full max-w-5xl flex justify-between items-center mb-6">
                <div className="flex items-center gap-4">
                    <img src={asset('images/tab.png')} className="w-10 h-10 object-contain" alt="FB Logo" />
                    <div>
            ...
            <div className="mt-8 text-center">
                <p className="text-slate-500 text-[9px] font-bold uppercase tracking-[0.4em]">Fulton Bank Bank | Document Security Systems</p>
            </div>
        </div>
    );
}
