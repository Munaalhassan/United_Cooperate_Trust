...
export default function CEOWelcome() {
    return (
        <PublicLayout>
            <Head title="CEO Welcome | Fulton Bank Bank" />
                        ...
                        <div className="max-w-3xl">
                            ...
                            <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-light">
                                {[
                                    ...
                                    "On behalf of everyone at Fulton Bank Bank , I thank you for the part you have played in our story so far and invite you to take a fresh look at what we have to offer. We are always here for you."
                                ].map((para, i) => (
                                    <motion.p 
                                        key={i}
                            ...
                            <div className="mt-16 pt-12 border-t border-slate-200">
                                ...
                                <div className="text-xs text-slate-400 font-medium mt-1 uppercase tracking-widest">Fulton Bank Bank</div>
                            </div>
                        </div>
                    </motion.div>
