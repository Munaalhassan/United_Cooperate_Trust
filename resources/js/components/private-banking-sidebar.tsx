...
export function PrivateBankingSidebar() {
    const { url } = usePage();
        ...
        <aside className="lg:w-80 flex-shrink-0">
            <div className="sticky top-32">
                ...
                <div className="mt-20 p-8 bg-brand-navy text-white overflow-hidden relative group">
                    ...
                    <h4 className="text-lg font-bold mb-4 relative z-10">Need Assistance?</h4>
                    <p className="text-xs text-white/60 mb-6 relative z-10 leading-relaxed">
                        Our dedicated advisory team is available 24/7 to support your global banking needs.
                    </p>
