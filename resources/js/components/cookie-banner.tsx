            ...
            {visible && (
                <>
                    ...
                    >
                            ...
                            {showManage && (
                                ...
                                >
                                    <div className="max-w-5xl mx-auto px-6 py-8">
                                        <h3 className="text-sm font-bold text-brand-navy uppercase tracking-widest mb-6">
                                        ...
                                        <div className="mt-8 flex items-center gap-4">
                                            <button
                                                ...
                                                className="px-8 py-2.5 bg-brand-navy text-white text-xs font-bold uppercase tracking-widest hover:bg-brand-blue transition-colors"
                                            >
                                                Save My Preferences
                                            </button>
                                            <button
                        ...
                        {/* Banner Content */}
                        <div className="max-w-5xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            {/* Icon + Text */}
                            ...
                            <div className="flex flex-wrap items-center gap-3 flex-shrink-0">
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-4 py-2 border border-slate-300 text-slate-600 text-xs font-bold uppercase tracking-wider hover:border-brand-blue hover:text-brand-blue transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 border border-slate-300 text-slate-600 text-xs font-bold uppercase tracking-wider hover:border-slate-500 transition-colors"
                                >
                                    Reject All
                                </button>
                                <button
                                    onClick={handleAcceptAll}
                                    className="px-6 py-2 bg-brand-navy text-white text-xs font-bold uppercase tracking-wider hover:bg-brand-blue transition-colors flex items-center gap-2"
                                >
