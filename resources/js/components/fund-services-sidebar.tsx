...
export function FundServicesSidebar() {
    const { url } = usePage();
        ...
        <aside className="lg:w-80 flex-shrink-0">
            <div className="sticky top-32">
                ...
                <div className="mt-20 p-8 bg-brand-navy text-white overflow-hidden relative group">
                    ...
                    <h4 className="text-lg font-bold mb-4 relative z-10">Institutional Expertise</h4>
                    <p className="text-xs text-white/60 mb-6 relative z-10 leading-relaxed">
                        Customized and superior quality service based on long term relationships and extensive experience.
                    </p>
                    <Link href="/contact" className="text-xs font-bold text-brand-blue hover:text-white transition-colors relative z-10 flex items-center gap-2">
                        CONTACT OUR EXPERTS <ChevronRight className="w-3 h-3" />
                    </Link>
                </div>
            </div>
        </aside>
