    ...
    return (
        <aside className="lg:w-80 flex-shrink-0">
            <div className="sticky top-32">
                ...
                {/* Secure Access Card */}
                <div className="mt-20 p-8 bg-brand-navy text-white overflow-hidden relative group rounded-sm shadow-xl">
                    ...
                    <h4 className="text-lg font-bold mb-4 relative z-10">Secure Your Banking</h4>
                    <p className="text-xs text-white/60 mb-6 relative z-10 leading-relaxed">
                        Learn how to keep your online banking experience secure with our state-of-the-art protections.
                    </p>
                    <Link href="/quick-services/security-awareness" className="text-xs font-bold text-brand-blue hover:text-white transition-colors relative z-10 flex items-center gap-2 uppercase tracking-widest">
